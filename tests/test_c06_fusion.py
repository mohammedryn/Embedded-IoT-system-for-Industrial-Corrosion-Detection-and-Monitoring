...
def _sensor(
    *,
    ...
    return {
        ...
        "expert_summary": "Electrochemical signal remains interpretable.",
        "mechanistic_interpretation": "Rp and current suggest a bounded corrosion state.",
        "corrosion_mode": "passive",
        "key_findings": ["sensor_ok"],
        "recommended_actions": ["retain as comparative benchmark"],
...
def _vision(
    *,
    ...
    return {
        ...
        "surface_summary": "Surface condition remains visually interpretable.",
        "pit_suspected": False,
        "pit_evidence": "no clear pit morphology observed",
        "suspected_damage_modes": ["surface_discoloration"],
        "key_findings": ["vision_ok"],
        "recommended_actions": ["capture a second view if severity increases"],
